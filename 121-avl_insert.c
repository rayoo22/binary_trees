 ...
 * Return: if the tree is NULL, your function must return 0
 * else return height
 */
size_t height(const binary_tree_t *tree)
{
...
/**
 * balance - measures the balance factor oof a binary tree
 ...
 * @tree: a double poointer to root node of the AVL tree to insert into.
 ...
 * @tree: a double pointer to the root node of the AVL tree to insert intp.
 * @value: the value to insert into the AVL tree.
