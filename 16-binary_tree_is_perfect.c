...
/**
 * binry_tree_is_perfect - checks if a binary tree is perfect
 * @tree: a pointer to the root node of the tree to check
 * Return: 1 if tree is perfect, 0 if the tree is not perfect
...
int binary_tree_is_perfect(const binary_tree_t *tree)
{
	...
	power = (size_t)_pow_recursion(1, height + 1);
	return (power - 1 == nodes);
}

/**
 * _pow_recursion - returns the value of x raised to the power of y
 * @x: the value to exponentiiate
 * @y: the poer to raise x to
